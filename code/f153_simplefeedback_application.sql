...
prompt  APPLICATION 153 - SimpleFeedback
--
-- Application Export:
--   Application:     153
--   Name:            SimpleFeedback
--   Date and Time:   08:47 Sunday April 6, 2014
--   Exported By:     COENRAADV@GMAIL.COM
--   Flashback:       0
--   Export Type:     Application Export
--   Version:         4.2.2.00.11
--   Instance ID:     61800351185657
--
-- Import:
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,2725830494710396));
...
begin
   ...
   -- SET APPLICATION ID
   wwv_flow.g_flow_id := nvl(wwv_flow_application_install.get_application_id,153);
...
begin
   ...
   -- Remove Application
wwv_flow_api.remove_flow(nvl(wwv_flow_application_install.get_application_id,153));
...
wwv_flow_audit.remove_audit_trail(nvl(wwv_flow_application_install.get_application_id,153));
null;
...
wwv_flow_api.create_flow(
  p_id    => nvl(wwv_flow_application_install.get_application_id,153),
  p_display_id=> nvl(wwv_flow_application_install.get_application_id,153),
  p_owner => nvl(wwv_flow_application_install.get_schema,'CBLUE'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'SimpleFeedback'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F_153'),
  p_page_view_logging => 'YES',
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20140406084717',
  ...
  p_authentication_id=> 17448110832297051 + wwv_flow_api.g_id_offset,
  p_logout_url=> '',
  p_application_tab_set=> 0,
  p_logo_image => 'TEXT:SimpleFeedback',
  p_public_url_prefix => '',
  p_public_user=> '',
  p_dbauth_url_prefix => '',
  ...
  p_last_updated_by => 'COENRAADV@GMAIL.COM',
  p_last_upd_yyyymmddhh24miss=> '20140406084717',
  p_ui_type_name => null,
...
wwv_flow_api.create_user_interface (
  p_id => 17447914676297029 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_setting (
  p_id => 17438029812296923 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
--application/shared_components/security/authorization/contribution_rights
wwv_flow_api.create_security_scheme (
  p_id => 17457310357308512 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_name => 'CONTRIBUTION RIGHTS'
 ,p_scheme_type => 'NATIVE_FUNCTION_BODY'
 ,p_attribute_01 => 'return eba_feedback.get_authorization_level(:APP_USER) >= 2;'
...
wwv_flow_api.create_icon_bar_item(
  p_id => 21230631163560025 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 10,
  p_icon_image => '',
  p_icon_subtext=> 'Feedback',
  p_icon_target=> 'javascript:apex.navigation.popup.url(''f?p=&APP_ID.:480:&SESSION.:::480:P480_APPLICATION_ID,P480_PAGE_ID:&APP_ID.,&APP_PAGE_ID.'');',
  p_icon_image_alt=> '',
  p_icon_height=> null,
  p_icon_width=> null,
  p_icon_height2=> null,
  ...
  p_cell_colspan      => 1,
  p_onclick=> '',
  p_icon_bar_comment=> 'javascript:apex.navigation.popup.url(''f?p=&APP_ID.:2:&SESSION.:::2:P2_APPLICATION_ID,P2_PAGE_ID:&APP_ID.,&APP_PAGE_ID.'');');
 
wwv_flow_api.create_icon_bar_item(
  p_id => 17448031586297047 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_icon_sequence=> 200,
  p_icon_image => '',
...
wwv_flow_api.create_tab (
  p_id=> 17449528053297121 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
  p_tab_text => 'Home',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '481',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/feedback_details
wwv_flow_api.create_tab (
  p_id=> 17572710457331350 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'Feedback Details',
  p_tab_text => 'Feedback Details',
  p_tab_step => 482,
...
--
--application/shared_components/user_interface/lov/types
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 17457026671308500 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'TYPES',
  p_lov_query=> 'select NAME as display_value, ID as return_value '||unistr('\000a')||
'  from EBA_FEEDBACK_TYPES'||unistr('\000a')||
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 1
 ,p_user_interface_id => 17447914676297029 + wwv_flow_api.g_id_offset
 ,p_tab_set => 'TS1'
 ,p_name => 'Home'
 ,p_step_title => 'Home'
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20140225164039'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 17449701314297128 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 17440120421296966+ wwv_flow_api.g_id_offset,
  ...
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(17449202077297113 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 17447227446297007+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 17439222540296950 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_page_comment => 'This page was generated by the feedback wizard'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140406044837'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 21226007096559992 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Feedback',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 17440822058296967+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => true,
  p_plug_new_grid_column  => true,
...
wwv_flow_api.create_page_button(
  p_id             => 21230001396560019 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 20,
  p_button_plug_id => 21226007096559992+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 21229821308560015 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
...
wwv_flow_api.create_page_item(
  p_id=>21226200935559995 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_APPLICATION_ID',
  p_data_type=> '',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 21226007096559992+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> '',
  p_prompt=>'Application:',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov=> 'select application_id||''. ''||application_name d, application_id v from apex_applications where application_id = :P2_APPLICATION_ID',
  ...
  p_field_template=> 17446232063297001+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_help_text=> h,
  p_attribute_01 => 'Y',
  p_attribute_02 => 'LOV',
...
wwv_flow_api.create_page_item(
  p_id=>21226716562560005 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_PAGE_ID',
  p_data_type=> '',
  ...
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov=> 'select page_id||''. ''||page_name d, page_id v from apex_application_pages where page_id = :P2_PAGE_ID and application_id = :P2_APPLICATION_ID',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 60,
  p_cMaxlength=> null,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21227221393560006 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_A',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>21227422548560006 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_FEEDBACK',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21227901002560007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_X',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>21228130211560007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_FEEDBACK_TYPE',
  p_data_type=> '',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21228621038560007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_Y',
  p_data_type=> 'VARCHAR',
...
begin
h := null;
h:=h||'Please supply this information to be logged as feedback.';

wwv_flow_api.create_page_item(
  p_id=>21228802807560013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_ATTRIBUTE1',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 50,
...
wwv_flow_api.create_page_item(
  p_id=>21229312401560013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_ATTRIBUTE2',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 60,
...
'    p_comment         => :P2_FEEDBACK,'||unistr('\000a')||
'    p_type            => :P2_FEEDBACK_TYPE,'||unistr('\000a')||
'    p_application_id  => :P2_APPLICATION_ID,'||unistr('\000a')||
'    p_page_id         => :P2_PAGE_ID,'||unistr('\000a')||
'    p_email           => null,'||unistr('\000a')||
'    p_attribute_01   => :P2_ATTRIBUTE1,'||unistr('\000a')||
'    p_label_01       => null,'||unistr('\000a')||
'    p_attribute_02   => :P2_ATTRIBUTE2,'||unistr('\000a')||
'    p_label_02       => null);';

wwv_flow_api.create_page_process(
  p_id     => 21230203613560020 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  ...
  p_process_when_button_id=>21229821308560015 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 21230417997560023 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
...
wwv_flow_api.create_page (
 ...
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'OFF'
 ,p_step_template => 17438114018296935 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140405172918'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 17448426963297085 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17448526609297094 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 17448426963297085+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17448627614297103 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17448727228297105 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(17446622868297003 + wwv_flow_api.g_id_offset),
  p_new_grid=> false,
...
wwv_flow_api.create_page_process(
  p_id     => 17448923383297113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 17448800313297106 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 17449100738297113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 17449002053297113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
--application/pages/page_00480
prompt  ...PAGE 480: Submit Feedback
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 480
 ,p_user_interface_id => 17447914676297029 + wwv_flow_api.g_id_offset
 ,p_name => 'Submit Feedback'
 ,p_step_title => 'Submit Feedback'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Submit Feedback'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'OFF'
 ,p_group_id => 666151659415763229 + wwv_flow_api.g_id_offset
 ,p_step_template => 17439222540296950 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'Y'
 ,p_protection_level => 'N'
 ,p_cache_page_yn => 'N'
...
'No help is available for this page.'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140406063628'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 17451813454308447 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 480,
  p_plug_name=> 'Submit Feedback',
  p_region_name=>'',
  p_escape_on_http_output=>'Y',
  p_plug_template=> 17439809721296957+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 17455013447308473 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 480,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(17495968101237570636 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 17447227446297007+ wwv_flow_api.g_id_offset,
  p_translate_title=> 'Y',
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
...
wwv_flow_api.create_page_button(
  p_id             => 17452007448308450 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 480,
  p_button_sequence=> 40,
  p_button_plug_id => 17451813454308447+wwv_flow_api.g_id_offset,
  p_button_name    => 'CANCEL',
  p_button_action  => 'REDIRECT_URL',
  p_button_image   => 'template:'||to_char(17446825713297005+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
  ...
  p_button_execute_validations=>'N',
  p_button_condition=> 'P480_CAME_FROM',
  p_button_condition2=> '100',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 17452232667308460 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 480,
  p_button_sequence=> 10,
  p_button_plug_id => 17451813454308447+wwv_flow_api.g_id_offset,
  p_button_name    => 'submit_feedback',
  p_button_action  => 'SUBMIT',
  p_button_image   => 'template:'||to_char(17446825713297005+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'Y',
  p_button_image_alt=> 'Submit Feedback',
...
wwv_flow_api.create_page_branch(
  p_id=>17456710080308494 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_branch_name=> '',
  p_branch_action=> 'f?p=&APP_ID.:482:&SESSION.::&DEBUG.:RP::',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>17452232667308460+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 10,
  p_branch_condition_type=> 'PLSQL_EXPRESSION',
  p_branch_condition=> '-- ACL enabled & not admin'||unistr('\000a')||
'(eba_feedback_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'') = ''Y'' and eba_feedback.get_authorization_level(:APP_USER) < 3)'||unistr('\000a')||
'or'||unistr('\000a')||
'-- ACL disabled'||unistr('\000a')||
'eba_feedback_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'') = ''N''',
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> 'Created 14-DEC-2011 08:16 by SHAKEEB');
 
wwv_flow_api.create_page_branch(
  p_id=>17456914358308498 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_branch_name=> '',
  p_branch_action=> 'f?p=&APP_ID.:480:&SESSION.::&DEBUG.:::',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>17452232667308460+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 20,
  p_branch_condition_type=> 'PLSQL_EXPRESSION',
  p_branch_condition=> 'eba_feedback_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'') = ''Y'' and eba_feedback.get_authorization_level(:APP_USER) = 3',
  p_save_state_before_branch_yn=>'N',
  p_security_scheme => 17457310357308512+ wwv_flow_api.g_id_offset,
  p_branch_comment=> 'Created 23-JUL-2012 13:27 by ALLAN');
...
begin
wwv_flow_api.create_page_item(
  p_id=>17452409210308461 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_CAME_FROM',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 220,
  p_item_plug_id => 17451813454308447+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17452626694308462 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_BROWSER',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'owa_util.get_cgi_env(''HTTP_USER_AGENT'');',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17452816485308463 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_REFERER',
  p_data_type=> 'VARCHAR',
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source=>'nvl(owa_util.get_cgi_env(''HTTP_REFERER''),''No referer defined.'');',
  p_source_type=> 'FUNCTION',
  p_display_as=> 'NATIVE_HIDDEN',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17453218322308464 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_COMPONENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 40,
  ...
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:Application;Application,Page;Page,Report;Report,General;General',
  ...
  p_field_template=> 17446405590297001+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'YES',
  p_protection_level => 'N',
  p_escape_on_http_output => 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17453426841308465 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_MODULE',
  p_data_type=> 'VARCHAR',
  ...
  p_lov_null_text=>'- Select -',
  p_lov_null_value=> '',
  p_lov_cascade_parent_items=> 'P480_COMPONENTS',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17453620787308465 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_TYPE',
  p_data_type=> 'VARCHAR',
  ...
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Feedback Type',
  p_pre_element_text=>'<br clear="all" />',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:General;General,Enhancement;Enhancement,Bug;Bug',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 4000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17453822265308467 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_FEEDBACK',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17454222077308470 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_X',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17454409593308470 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_FILE',
  p_data_type=> 'VARCHAR',
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Screenshot/Supporting File',
...
begin
wwv_flow_api.create_page_item(
  p_id=>17454605676308471 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_COMMENT_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 210,
...
begin
wwv_flow_api.create_page_item(
  p_id=>17454820872308471 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_X2',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21231103824572986 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_APPLICATION_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21232531847575122 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 480,
  p_name=>'P480_PAGE_ID',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 17455523221308480 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 480,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P480_FILE Not Null',
  p_validation_sequence=> 20,
  p_validation => 'P480_FILE',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => '#LABEL# must have some value.',
  p_always_execute=>'N',
  p_validation_condition_type=> 'NEVER',
  p_only_for_changed_rows=> 'Y',
  p_associated_item=> 17454409593308470 + wwv_flow_api.g_id_offset,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'insert into FEEDBACK_COMMENTS'||unistr('\000a')||
'('||unistr('\000a')||
'  application_id,'||unistr('\000a')||
'  page_id,'||unistr('\000a')||
'  feedback_type,'||unistr('\000a')||
'--  TYPE_ID,'||unistr('\000a')||
'--  COMPONENT,'||unistr('\000a')||
'--  MODULE_ID,'||unistr('\000a')||
'  STATUS,'||unistr('\000a')||
'  FEEDBACK,'||unistr('\000a')||
'--  CONTACT_YN,'||unistr('\000a')||
'--  EMAIL,'||unistr('\000a')||
'  REFERER,'||unistr('\000a')||
'  BROWSER'||unistr('\000a')||
')'||unistr('\000a')||
'values'||unistr('\000a')||
'('||unistr('\000a')||
'  :P480_APPLICATION_ID,'||unistr('\000a')||
'  :P480_PAGE_ID,'||unistr('\000a')||
'  :P480_TYPE,'||unistr('\000a')||
'--  :P480_COMPONENT,'||unistr('\000a')||
'--  :P480_MODULE,'||unistr('\000a')||
'   ''New'','||unistr('\000a')||
'  :P480_FEEDBACK,'||unistr('\000a')||
'--  :P480_CONTACT,'||unistr('\000a')||
'--  NVL(:P480_EMAIL,:APP_USER),'||unistr('\000a')||
'  :P480_REFERER,'||unistr('\000a')||
'  :P480_';

p:=p||'BROWSER'||unistr('\000a')||
') returning id into :P480_COMMENT_ID;'||unistr('\000a')||
'commit;';

wwv_flow_api.create_page_process(
  p_id     => 17455614144308480 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 480,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_success_message=> 'Feedback Accepted.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
null;
...
'  l_file_id      FEEDBACK_FILES.ID%type;'||unistr('\000a')||
'  l_file         FEEDBACK_FILES.FILE_BLOB%type;'||unistr('\000a')||
'  l_filename     FEEDBACK_FILES.FILE_NAME%type;'||unistr('\000a')||
'  l_mimetype     FEEDBACK_FILES.FILE_MIMETYPE%type;'||unistr('\000a')||
'  l_charset      FEEDBACK_FILES.FILE_CHARSET%type;'||unistr('\000a')||
'  l_action       varchar2(10);'||unistr('\000a')||
'  l_existing_cnt pls_integer;'||unistr('\000a')||
'begin'||unistr('\000a')||
'  -- Get the data we need to insert into FEEDBACK_FILES with'||unistr('\000a')||
'  begin'||unistr('\000a')||
'    select f.blo';

p:=p||'b_content,'||unistr('\000a')||
'           f.filename,'||unistr('\000a')||
'           f.mime_type,'||unistr('\000a')||
'           nvl(f.file_charset, f.dad_charset)'||unistr('\000a')||
'      into l_file,'||unistr('\000a')||
'           l_filename,'||unistr('\000a')||
'           l_mimetype,'||unistr('\000a')||
'           l_charset'||unistr('\000a')||
'      from wwv_flow_files f'||unistr('\000a')||
'     where lower(f.name) = lower(:P480_FILE);'||unistr('\000a')||
'  exception'||unistr('\000a')||
'    when no_data_found then'||unistr('\000a')||
'      l_file := null;'||unistr('\000a')||
'  end;'||unistr('\000a')||
''||unistr('\000a')||
'  if l_file is not null then'||unistr('\000a')||
'    select count(*)'||unistr('\000a')||
'      into l_exis';

p:=p||'ting_cnt'||unistr('\000a')||
'      from feedback_files'||unistr('\000a')||
'     where lower(file_name) = lower(l_filename);'||unistr('\000a')||
'  end if;'||unistr('\000a')||
''||unistr('\000a')||
'  if l_existing_cnt = 0 then'||unistr('\000a')||
'    insert into feedback_files'||unistr('\000a')||
'    ('||unistr('\000a')||
'      id,'||unistr('\000a')||
'      comment_id,'||unistr('\000a')||
'      file_name,'||unistr('\000a')||
'      file_blob,'||unistr('\000a')||
...
'    values'||unistr('\000a')||
'    ('||unistr('\000a')||
'      l_file_id,'||unistr('\000a')||
'      :P480_COMMENT_ID,'||unistr('\000a')||
'      l';

p:=p||'_filename,'||unistr('\000a')||
'      l_file,'||unistr('\000a')||
'      initcap(:APP_USER),'||unistr('\000a')||
'      localtimestamp,'||unistr('\000a')||
'      initcap(:APP_USER),'||unistr('\000a')||
'      localtimestamp,'||unistr('\000a')||
'      l_mimetype,'||unistr('\000a')||
'      l_charset'||unistr('\000a')||
'    ) returning id into l_file_id;'||unistr('\000a')||
'  '||unistr('\000a')||
'    delete from wwv_flow_files where name = :P480_FILE;'||unistr('\000a')||
''||unistr('\000a')||
'  else'||unistr('\000a')||
'    update feedback_files'||unistr('\000a')||
'       set file_blob = l_file,'||unistr('\000a')||
'           updated_by = initcap(:APP_USER),'||unistr('\000a')||
'           updated = localtimestamp,'||unistr('\000a')||
'     ';

p:=p||'      file_lastupd = updated'||unistr('\000a')||
'     where lower(file_name) = lower(l_filename);'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 17455811636308481 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 480,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when=>'P480_FILE',
  p_process_when_type=>'ITEM_IS_NOT_NULL',
  p_only_for_changed_rows=> 'Y',
  p_process_success_message=> 'Screenshot/Supporting File uploaded.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
null;
...
---------------------------------------
-- ...updatable report columns for page 480
--
...
--application/pages/page_00481
prompt  ...PAGE 481: Feedback
--
...
wwv_flow_api.create_page (
 ...
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ,p_group_id => 666149039198747949 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_protection_level => 'N'
 ,p_cache_page_yn => 'N'
 ,p_cache_timeout_seconds => 21600
 ,p_cache_by_user_yn => 'N'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140316175100'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 17461724549771873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  ...
  p_plug_item_display_point=> 'ABOVE',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(14971445954064768914 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 17447227446297007+ wwv_flow_api.g_id_offset,
  p_plug_query_row_template=> 1,
  p_plug_query_headings_type=> 'COLON_DELMITED_LIST',
  p_plug_query_row_count_max => 500,
...
'    c.id,'||unistr('\000a')||
'    c.row_version_number,'||unistr('\000a')||
'    c.row_key,'||unistr('\000a')||
'    t.name as type,'||unistr('\000a')||
'    c.component_id,'||unistr('\000a')||
'    c.component_name component,'||unistr('\000a')||
'    c.module_id,'||unistr('\000a')||
'    c.module_name module,'||unistr('\000a')||
'    c.feedback,'||unistr('\000a')||
'    decode(c.contact_yn,''Y'',''Yes'',''No'') contact_yn,'||unistr('\000a')||
'    c.created,'||unistr('\000a')||
'    lower(c.created_by) created_by,'||unistr('\000a')||
'    c.updated,'||unistr('\000a')||
'    lower(c.updated_by) updated_by,'||unistr('\000a')||
'    c.tags,'||unistr('\000a')||
'    (select count(*) from eba_feedback_files ';

s:=s||'f where f.comment_id = c.id) files'||unistr('\000a')||
'from'||unistr('\000a')||
'    feedback_comments c,'||unistr('\000a')||
'    eba_feedback_types t'||unistr('\000a')||
'where'||unistr('\000a')||
'    t.id = c.type_id';

wwv_flow_api.create_page_plug (
  p_id=> 17461910375771878 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_plug_name=> 'Feedback',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 17441205925296968+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_new_grid         => false,
  p_plug_new_grid_row     => false,
  p_plug_new_grid_column  => false,
...
a1:=a1||'f where f.comment_id = c.id) files'||unistr('\000a')||
'from'||unistr('\000a')||
'    feedback_comments c,'||unistr('\000a')||
'    eba_feedback_types t'||unistr('\000a')||
'where'||unistr('\000a')||
...
wwv_flow_api.create_worksheet(
  p_id=> 17462108228771883+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_region_id=> 17461910375771878+wwv_flow_api.g_id_offset,
  p_name=> 'Feedback',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_owner=>'MIKE',
  p_internal_uid=> 17462108228771883);
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462224251771894+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
  p_display_order          =>1,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462302015771914+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462409541771915+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  ...
  p_report_label           =>'Row Key',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_column_link            =>'f?p=&APP_ID.:26:&SESSION.::&DEBUG.:26:P26_ID:#ID#',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462524595771915+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  ...
  p_column_label           =>'Selected Component',
  p_report_label           =>'Selected Component',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462602087771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  ...
  p_column_label           =>'Selected Sub Component',
  p_report_label           =>'Selected Sub Component',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462722954771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462830786771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CONTACT_YN',
  p_display_order          =>8,
  p_column_identifier      =>'H',
  p_column_label           =>'Contact',
  p_report_label           =>'Contact',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17462930775771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463032211771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463125103771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463207737771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463322804771924+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463429142771925+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  ...
  p_column_label           =>'Sub Component',
  p_report_label           =>'Sub Component',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463510735771926+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463622494771926+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 17463722765771926+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'ROW_KEY:TYPE:COMPONENT:MODULE:FEEDBACK:FILES:CONTACT_YN:CREATED:CREATED_BY:TAGS:UPDATED:';

wwv_flow_api.create_worksheet_rpt(
  p_id => 17463820469771936+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 481,
  p_worksheet_id => 17462108228771883+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 17464017086771944 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 481,
  p_button_sequence=> 10,
  p_button_plug_id => 17461910375771878+wwv_flow_api.g_id_offset,
  p_button_name    => 'RESET_REPORT',
  p_button_action  => 'REDIRECT_PAGE',
  p_button_image   => 'template:'||to_char(17446722917297005+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
  p_button_image_alt=> 'Reset Report',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=&APP_ID.:481:&SESSION.::&DEBUG.:15,RIR::',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
---------------------------------------
-- ...updatable report columns for page 481
--
...
--application/pages/page_00482
prompt  ...PAGE 482: Feedback Details
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140406050849'
  );
null;
...
'"UPDATED",'||unistr('\000a')||
'"UPDATED_BY"'||unistr('\000a')||
'from "#OWNER#"."FEEDBACK_COMMENTS"'||unistr('\000a')||
'';

wwv_flow_api.create_report_region (
  p_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_name=> 'Feedback Details',
  p_region_name=>'',
  p_template=> 17442114932296968+ wwv_flow_api.g_id_offset,
  ...
  p_translate_title=> 'Y',
  p_ajax_enabled=> 'N',
  p_query_row_template=> 17443811706296981+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 17578101590331385 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573132695331357 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  ...
  p_is_required=> false,
  p_ref_schema=> 'CBLUE',
  p_ref_table_name=> 'FEEDBACK_COMMENTS',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573223316331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  ...
  p_column_link=>'f?p=&APP_ID.:483:&SESSION.::&DEBUG.::P483_ID:#ID#',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573313408331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573400356331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573504991331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573610840331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  p_column_alias=> 'REFERER',
  p_column_display_sequence=> 9,
  p_column_heading=> 'Referer',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573713834331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
  p_column_alias=> 'BROWSER',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17573820061331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 20282411661872060 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574023145331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574124513331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574222965331358 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
  p_column_alias=> 'CONTACT_YN',
  p_column_display_sequence=> 16,
  p_column_heading=> 'Contact Yn',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574332575331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574430049331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  ...
  p_ref_schema=> 'CBLUE',
  p_ref_table_name=> 'FEEDBACK_COMMENTS',
  p_ref_column_name=> 'COMPONENT_NAME',
  p_column_comment=>'');
end;
/
declare
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574520510331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17581229999450378 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  ...
  p_inline_lov=> 'STATIC:New;New,Open;Open,Closed;Closed ',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17581316855450380 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574623924331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574727616331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574831661331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 17574926121331359 + wwv_flow_api.g_id_offset,
  p_region_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
'"CREATED_BY",'||unistr('\000a')||
'"UPDATED"'||unistr('\000a')||
'from "#OWNER#"."FEEDBACK_COMMENTS"';

wwv_flow_api.create_page_plug (
  p_id=> 21215019378353126 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_plug_name=> 'Feedback Summary',
  p_region_name=>'',
  p_escape_on_http_output=>'N',
  p_plug_template=> 17441205925296968+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet(
  p_id=> 21215104431353126+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_region_id=> 21215019378353126+wwv_flow_api.g_id_offset,
  p_name=> 'Feedback Summary',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_icon_view_columns_per_row=>1,
  p_detail_view_enabled_yn=>'N',
  p_owner=>'COENRAADV@GMAIL.COM',
  p_internal_uid=> 21215104431353126);
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21215410924353152+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ID',
  p_display_order          =>2,
  p_column_identifier      =>'B',
  p_column_label           =>'Edit',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216030069353153+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ROW_KEY',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216307696353153+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FEEDBACK',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216611710353154+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216721718353154+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216802487353154+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21216913493353155+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21217019744353155+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CREATED',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21217128641353155+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CREATED_BY',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 21217219093353155+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'UPDATED',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'ID:ROW_KEY:STATUS:COMPONENT_NAME:MODULE_NAME:FEEDBACK:NOTES:CREATED:CREATED_BY:UPDATED:';

wwv_flow_api.create_worksheet_rpt(
  p_id => 21217421455353664+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 482,
  p_worksheet_id => 21215104431353126+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page_button(
  p_id             => 17575315275331366 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 482,
  p_button_sequence=> 40,
  p_button_plug_id => 17572802903331351+wwv_flow_api.g_id_offset,
  p_button_name    => 'ADD',
  p_button_action  => 'REDIRECT_URL',
  p_button_image   => 'template:'||to_char(17446622868297003+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
...
wwv_flow_api.create_page_button(
  p_id             => 17575126392331366 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 482,
...
wwv_flow_api.create_page_button(
  p_id             => 17575029737331365 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 482,
  p_button_sequence=> 10,
  p_button_plug_id => 17572802903331351+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 17575216582331366 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 482,
  p_button_sequence=> 20,
  p_button_plug_id => 17572802903331351+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>17578229071331385 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 482,
  p_branch_name=> '',
  p_branch_action=> 'f?p=&APP_ID.:482:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 1,
  p_save_state_before_branch_yn=>'N',
...
wwv_flow_api.create_page_validation(
  p_id => 17576408141331379 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
  p_validation_name => 'TYPE_ID not null',
  p_validation_sequence=> 40,
  p_validation => 'TYPE_ID',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => '#COLUMN_HEADER# must have a value.',
  p_when_button_pressed=> 17575126392331366 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 17576613674331380 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 17576821395331381 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_validation(
  p_id => 17577006648331381 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
  p_validation_name => 'REFERER not null',
  p_validation_sequence=> 60,
  p_validation => 'REFERER',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => '#COLUMN_HEADER# must have a value.',
  p_when_button_pressed=> 17575126392331366 + wwv_flow_api.g_id_offset,
  p_exec_cond_for_each_row=> 'N',
  p_only_for_changed_rows=> 'Y',
  p_associated_column=> 'REFERER',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 17577226240331381 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
  p_validation_name => 'BROWSER not null',
  p_validation_sequence=> 70,
  p_validation => 'BROWSER',
  p_validation_type => 'ITEM_NOT_NULL',
  p_error_message => '#COLUMN_HEADER# must have a value.',
  p_when_button_pressed=> 17575126392331366 + wwv_flow_api.g_id_offset,
  p_exec_cond_for_each_row=> 'N',
  p_only_for_changed_rows=> 'Y',
  p_associated_column=> 'BROWSER',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 17577421393331381 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
  p_validation_name => 'COMPONENT_ID must be numeric',
  p_validation_sequence=> 90,
  p_validation => 'COMPONENT_ID',
  p_validation_type => 'ITEM_IS_NUMERIC',
  p_error_message => '#COLUMN_HEADER# must be numeric.',
  p_when_button_pressed=> 17575126392331366 + wwv_flow_api.g_id_offset,
  p_exec_cond_for_each_row=> 'N',
  p_only_for_changed_rows=> 'Y',
  p_associated_column=> 'COMPONENT_ID',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 17577622473331381 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_tabular_form_region_id => 17572802903331351 + wwv_flow_api.g_id_offset,
  p_validation_name => 'MODULE_ID must be numeric',
  p_validation_sequence=> 100,
  p_validation => 'MODULE_ID',
  p_validation_type => 'ITEM_IS_NUMERIC',
  p_error_message => '#COLUMN_HEADER# must be numeric.',
  p_when_button_pressed=> 17575126392331366 + wwv_flow_api.g_id_offset,
  p_exec_cond_for_each_row=> 'N',
  p_only_for_changed_rows=> 'Y',
  p_associated_column=> 'MODULE_ID',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FEEDBACK_COMMENTS:ROWID';

wwv_flow_api.create_page_process(
  p_id     => 17577723725331381 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>17575126392331366 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 17577902541331383 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 482,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
---------------------------------------
-- ...updatable report columns for page 482
--
 
begin
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579115864450374 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 1,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579226860450376 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 2,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579330582450376 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 3,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579400853450376 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 4,
  p_query_column_name=> 'TYPE_ID',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579508155450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 5,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579627613450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 6,
  p_query_column_name=> 'REFERER',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579704373450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 7,
  p_query_column_name=> 'BROWSER',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17579813895450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 8,
  p_query_column_name=> 'ROW_KEY',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 20281130394872051 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 9,
  p_query_column_name=> 'COMPONENT',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580001181450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580123572450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 11,
  p_query_column_name=> 'FEEDBACK',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580204396450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 12,
  p_query_column_name=> 'CONTACT_YN',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580317439450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 13,
  p_query_column_name=> 'TAGS',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580402969450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 14,
  p_query_column_name=> 'COMPONENT_NAME',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580515192450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580630591450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580717901450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580803911450377 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
  p_column_sequence=> 18,
  p_query_column_name=> 'CREATED',
  p_display_as=> 'TEXT',
  p_column_comment=> '');
 
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17580917663450378 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17581008258450378 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_region_rpt_cols (
  p_id     => 17581129027450378 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_plug_id=> 17572802903331351 + wwv_flow_api.g_id_offset,
...
--application/pages/page_00483
prompt  ...PAGE 483: Feedback Details
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140406084701'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 21196528317804811 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 483,
...
wwv_flow_api.create_page_button(
  p_id             => 21196809597804819 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 483,
  p_button_sequence=> 30,
  p_button_plug_id => 21196528317804811+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_action  => 'SUBMIT',
  p_button_image   => 'template:'||to_char(17446622868297003+wwv_flow_api.g_id_offset),
  p_button_is_hot=>'N',
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P483_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 21197132305804820 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 483,
  p_button_sequence=> 10,
  p_button_plug_id => 21196528317804811+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=&APP_ID.:482:&SESSION.::&DEBUG.:::',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 21196706762804819 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 483,
  p_button_sequence=> 40,
  p_button_plug_id => 21196528317804811+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 21196906897804819 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 483,
  p_button_sequence=> 20,
  p_button_plug_id => 21196528317804811+wwv_flow_api.g_id_offset,
  ...
  p_button_execute_validations=>'N',
  p_button_condition=> 'P483_ID and 1 = 2',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
...
wwv_flow_api.create_page_branch(
  p_id=>21197725530804827 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_branch_name=> '',
  p_branch_action=> 'f?p=&APP_ID.:483:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_sequence=> 1,
  p_save_state_before_branch_yn=>'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21197926104804881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 21196528317804811+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Id',
  p_source=>'ID',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21198104104804901 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_ROW_VERSION_NUMBER',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 17446521992297001+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'YES',
  p_protection_level => 'N',
  p_escape_on_http_output => 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21198324979804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_TYPE_ID',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21198521274804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_EMAIL',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21198720338804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_REFERER',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21198921487804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_BROWSER',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21199119667804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_ROW_KEY',
  p_data_type=> 'VARCHAR',
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 17446322787297001+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'YES',
  p_protection_level => 'N',
  p_escape_on_http_output => 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21199316096804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_COMPONENT_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21199512311804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_MODULE_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 90,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21199722790804903 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_FEEDBACK',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 260,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21199917729804905 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_CONTACT_YN',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 290,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21200131951804905 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_TAGS',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21200327058804905 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_COMPONENT_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 100,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21200515323804905 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_MODULE_NAME',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 120,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21200725379804906 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_CREATED',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21201103555804917 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_CREATED_BY',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 340,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21201322063804917 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_UPDATED',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21201704853804920 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_UPDATED_BY',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 360,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21201929087804920 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_STATUS',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'STATIC2:New;New,Open;Open,Closed;Closed ',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 32,
  p_cMaxlength=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21202113942804921 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_NOTES',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21202310686804921 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_COMPONENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 200,
...
begin
wwv_flow_api.create_page_item(
  p_id=>21223222904435687 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 483,
  p_name=>'P483_FILES',
  p_data_type=> 'VARCHAR',
  ...
  p_attribute_03 => 'declare'||unistr('\000a')||
'  l_val long;'||unistr('\000a')||
'begin'||unistr('\000a')||
'  for c in'||unistr('\000a')||
'  ('||unistr('\000a')||
'    select'||unistr('\000a')||
'      ''<a href="'' || APEX_UTIL.GET_BLOB_FILE_SRC(''P484_FILE'', id) || ''">'' || apex_escape.html(FILE_NAME) || ''</a><br />'' as link'||unistr('\000a')||
'    from'||unistr('\000a')||
'      FEEDBACK_FILES'||unistr('\000a')||
'    where'||unistr('\000a')||
'      comment_id = :P483_ID'||unistr('\000a')||
'  )'||unistr('\000a')||
'  loop'||unistr('\000a')||
'    l_val := l_val || c.link;'||unistr('\000a')||
'  end loop;'||unistr('\000a')||
'  if l_val is not null then'||unistr('\000a')||
'    htp.p(l_val);'||unistr('\000a')||
'  else'||unistr('\000a')||
'    htp.p(''<em>'' || apex_lang.message(''NO_FILES'') || ''.</em>'');'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'exception'||unistr('\000a')||
'  when no_data_found then'||unistr('\000a')||
'    null;'||unistr('\000a')||
...
wwv_flow_api.create_page_validation(
  p_id => 21201031510804909 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P483_CREATED must be timestamp',
  p_validation_sequence=> 150,
  p_validation => 'P483_CREATED',
  p_validation_type => 'ITEM_IS_TIMESTAMP',
  p_error_message => '#LABEL# must be a valid timestamp.',
  p_associated_item=> 21200725379804906 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_validation(
  p_id => 21201612372804920 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P483_UPDATED must be timestamp',
  p_validation_sequence=> 170,
  p_validation => 'P483_UPDATED',
  p_validation_type => 'ITEM_IS_TIMESTAMP',
  p_error_message => '#LABEL# must be a valid timestamp.',
  p_associated_item=> 21201322063804917 + wwv_flow_api.g_id_offset,
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FEEDBACK_COMMENTS:P483_ID:ID';

wwv_flow_api.create_page_process(
  p_id     => 21202704269804927 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FEEDBACK_COMMENTS',
  p_process_sql_clob => p,
  p_process_error_message=> '',
  p_error_display_location=> 'ON_ERROR_PAGE',
  p_process_success_message=> '',
...
'    if :P483_ID is null then'||unistr('\000a')||
'        select "FEEDBACK_COMMENT_SEQ".nextval'||unistr('\000a')||
'          into :P483_ID'||unistr('\000a')||
'          from sys.dual;'||unistr('\000a')||
'    end if;'||unistr('\000a')||
'end;';

wwv_flow_api.create_page_process(
  p_id     => 21202926457804930 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>21196706762804819 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:FEEDBACK_COMMENTS:P483_ID:ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 21203116103804930 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of FEEDBACK_COMMENTS',
  p_process_sql_clob => p,
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
...
wwv_flow_api.create_page_process(
  p_id     => 21203332693804930 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 483,
  ...
  p_process_error_message=> '',
  p_error_display_location=> 'INLINE_IN_NOTIFICATION',
  p_process_when_button_id=>21196906897804819 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
---------------------------------------
-- ...updatable report columns for page 483
--
...
--application/pages/page_00484
prompt  ...PAGE 484: Display File
--
...
wwv_flow_api.create_page (
 ...
 ,p_user_interface_id => 17447914676297029 + wwv_flow_api.g_id_offset
 ,p_name => 'Display File'
 ,p_step_title => 'Display File'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'Display File'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'NO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
 ...
 ,p_cache_by_user_yn => 'N'
 ,p_last_updated_by => 'COENRAADV@GMAIL.COM'
 ,p_last_upd_yyyymmddhh24miss => '20140406084549'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 21240220773981296 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 484,
  p_plug_name=> 'Files',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21240411517981300 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 484,
  p_name=>'P484_FILE',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
  p_item_plug_id => 21240220773981296+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Attachment',
  p_source=>'FILE_BLOB',
...
begin
wwv_flow_api.create_page_item(
  p_id=>21240620143981303 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 484,
  p_name=>'P484_ID',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:FEEDBACK_FILES:P484_ID:ID';

wwv_flow_api.create_page_process(
  p_id     => 21240829198981306 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 484,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from FEEDBACK_FILES',
  p_process_sql_clob => p,
  p_process_error_message=> '#SQLERRM_TEXT#',
  p_error_display_location=> 'ON_ERROR_PAGE',
  p_only_for_changed_rows=> 'Y',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_return_key_into_item1=>'P484_ID',
  p_process_comment=>'');
end;
null;
...
---------------------------------------
-- ...updatable report columns for page 484
--
...
wwv_flow_api.create_menu (
  p_id=> 17449202077297113 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>17449610283297123 + wwv_flow_api.g_id_offset,
  p_menu_id=>17449202077297113 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
prompt  ...page templates for application: 153
--
--application/shared_components/user_interface/templates/page/login
prompt  ......Page template 17438114018296935
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438114018296935 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
 ,p_name => 'Login'
 ,p_is_popup => false
...
prompt  ......Page template 17438204782296946
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438204782296946 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438309690296947
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438309690296947 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438414764296948
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438414764296948 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438518853296948
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438518853296948 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438619387296949
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438619387296949 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438710885296949
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438710885296949 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438826316296949
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438826316296949 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17438904990296950
 
begin
 
wwv_flow_api.create_template (
  p_id => 17438904990296950 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439015406296950
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439015406296950 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439104938296950
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439104938296950 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439222540296950
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439222540296950 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
 ,p_name => 'Popup'
 ,p_is_popup => false
...
prompt  ......Page template 17439310019296951
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439310019296951 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439419853296951
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439419853296951 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439504129296951
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439504129296951 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439632166296952
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439632166296952 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Page template 17439722016296953
 
begin
 
wwv_flow_api.create_template (
  p_id => 17439722016296953 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_theme_id => 24
...
prompt  ......Button Template 17446622868297003
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17446622868297003 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 17446722917297005
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17446722917297005 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 17446825713297005
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17446825713297005 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 17446912992297005
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17446912992297005 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 17447029036297005
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17447029036297005 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......Button Template 17447110519297005
 
begin
 
wwv_flow_api.create_button_templates (
  p_id => 17447110519297005 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
...
prompt  ......region template 17439809721296957
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17439809721296957 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17439910918296966
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17439910918296966 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440025177296966
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440025177296966 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440120421296966
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440120421296966 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440207883296966
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440207883296966 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440323654296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440323654296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uButtonRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17440428959296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440428959296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440523118296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440523118296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17440616494296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440616494296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440715210296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440715210296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17440822058296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440822058296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17440911730296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17440911730296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441016253296967
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441016253296967 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441126882296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441126882296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441205925296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441205925296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<div id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES# class="#REGION_CSS_CLASSES#">'||unistr('\000a')||
...
prompt  ......region template 17441316720296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441316720296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441414109296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441414109296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441511988296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441511988296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17441616040296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441616040296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441704919296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441704919296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441807324296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441807324296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17441930244296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17441930244296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17442014077296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442014077296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442114932296968
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442114932296968 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442210315296969
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442210315296969 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17442301381296969
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442301381296969 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442412306296969
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442412306296969 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442519201296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442519201296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17442612184296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442612184296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442712289296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442712289296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion uWhiteRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17442811454296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442811454296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......region template 17442923692296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17442923692296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17443011376296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17443011376296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
'<section class="uRegion #REGION_CSS_CLASSES# clearfix" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||unistr('\000a')||
...
prompt  ......region template 17443125702296970
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 17443125702296970 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_layout => 'TABLE'
 ,p_template => 
...
prompt  ......list template 17444302001296985
...
wwv_flow_api.create_list_template (
  p_id=>17444302001296985 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 17444430593296993
...
wwv_flow_api.create_list_template (
  p_id=>17444430593296993 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17444502512296994
...
wwv_flow_api.create_list_template (
  p_id=>17444502512296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17444603977296994
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17444603977296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17444718847296994
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17444718847296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17444828136296994
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17444828136296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17444906141296994
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17444906141296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445031322296994
...
wwv_flow_api.create_list_template (
  p_id=>17445031322296994 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445111200296995
...
wwv_flow_api.create_list_template (
  p_id=>17445111200296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445203159296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445203159296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445320530296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445320530296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445409715296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445409715296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445511193296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445511193296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445625977296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445625977296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445725419296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445725419296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445827309296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445827309296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 17445900868296995
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>17445900868296995 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 17443204920296973
...
wwv_flow_api.create_row_template (
  p_id=> 17443204920296973 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443315078296980
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443315078296980 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443428116296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443428116296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443517489296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443517489296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443623765296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443623765296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443704237296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443704237296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443811706296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443811706296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17443913151296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17443913151296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17444016642296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17444016642296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17444105307296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17444105307296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 17444202086296981
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 17444202086296981 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446028094296998
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446028094296998 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446122902297000
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446122902297000 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446232063297001
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446232063297001 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446322787297001
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446322787297001 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446405590297001
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446405590297001 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 17446521992297001
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 17446521992297001 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 17447227446297007
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 17447227446297007 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 17447300315297010
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 17447300315297010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 17447714874297019
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 17447714874297019 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 17447408182297013
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 17447408182297013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 17447521998297018
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 17447521998297018 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 17447613058297018
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 17447613058297018 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 17447805546297028
begin
wwv_flow_api.create_theme (
  p_id =>17447805546297028 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 24,
  p_theme_name=>'Cloudy',
  p_ui_type_name=>'DESKTOP',
  p_is_locked=>false,
  p_default_page_template=>17438904990296950 + wwv_flow_api.g_id_offset,
  p_error_template=>17438414764296948 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=>17439310019296951 + wwv_flow_api.g_id_offset,
  p_breadcrumb_display_point=>'REGION_POSITION_01',
  p_sidebar_display_point=>'REGION_POSITION_02',
  p_login_template=>17438114018296935 + wwv_flow_api.g_id_offset,
  p_default_button_template=>17446622868297003 + wwv_flow_api.g_id_offset,
  p_default_region_template=>17442114932296968 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>17440523118296967 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>17440822058296967 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>17442114932296968 + wwv_flow_api.g_id_offset,
  p_default_tabform_template=>17442114932296968 + wwv_flow_api.g_id_offset,
  p_default_wizard_template=>17442923692296970 + wwv_flow_api.g_id_offset,
  p_default_menur_template=>17440120421296966 + wwv_flow_api.g_id_offset,
  p_default_listr_template=>17440428959296967 + wwv_flow_api.g_id_offset,
  p_default_irr_template=>17441205925296968 + wwv_flow_api.g_id_offset,
  p_default_report_template   =>17443811706296981 + wwv_flow_api.g_id_offset,
  p_default_label_template=>17446232063297001 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>17447227446297007 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>17447408182297013 + wwv_flow_api.g_id_offset,
  p_default_list_template=>17445725419296995 + wwv_flow_api.g_id_offset,
  p_default_option_label=>17446322787297001 + wwv_flow_api.g_id_offset,
  ...
  p_default_required_label=>17446521992297001 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ...Language Maps for Application 153
--
...
wwv_flow_api.create_shortcut (
 p_id=> 17575721910331373 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......authentication 17448110832297051
 
begin
 
wwv_flow_api.create_authentication (
  p_id => 17448110832297051 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
